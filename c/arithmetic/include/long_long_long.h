...
void lllAdd32(uint8_t *output, const uint8_t *input1, uint32_t input2,
              uint32_t size);
...
void lllMul32(uint8_t *output, const uint8_t *input1, uint32_t input2,
              uint32_t size);

const uint8_t *lllHigh(const uint8_t *a, uint32_t size);

void lllDiv8(uint8_t *quotient, const uint8_t *dividend, uint8_t divisor,
             uint8_t *remainder, uint32_t size);

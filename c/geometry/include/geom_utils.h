...
static inline float sqr(const float a) { return a * a; }
...
void cartesian2polar_pt(Point2f inpts[], Point2f outpts[], int npts,
                        Point2f origin);

void cartesian2polar_vec(Vector2f inVectors[], Point2f outVectors[], int nvecs);

void polar2cartesian_pt(Point2f pts[], Point2f outpts[], int npts,
                        Point2f origin);

void polar2cartesian_vec(Vector2f invecs[], Vector2f outvecs[], int nvecs);

void triCircumcircle(Point2f pt1, Point2f pt2, Point2f pt3, Point2f *center,
                     float *radius);
